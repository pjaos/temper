class LCD(object):
    """@brief Allow an I2C LCD display (E.G 20x4, 16x2 ascii character, etc)) to be controlled from a Raspberry
...
#        self._wr(LCD.CLEAR_DISPLAY)
        for line_num in range(1, self._rows + 1):
            self.write_line(" " * self._width, line_num)
